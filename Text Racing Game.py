...
if gate1 == "low":
    ...
    print(
        "You have to decide what the best way to react to the driver next to you is...")
    sleep(2)
    ...
    if gate2 == "gas":
        ...
        if gate3 == "risky":
            ...
            print(
                "You recall your crew chief telling you to take it easy on the straights as your oil is over-temping.")
            sleep(2)
